...
int64_t LawnApp::ChallengeCompletionLocation(GameMode theGameMode)
{
	switch (theGameMode)
	{
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_1:
		return PVZRAPData::Locations::SURVIVAL_DAY_CLEAR;
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_2:
		return PVZRAPData::Locations::SURVIVAL_NIGHT_CLEAR;
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_3:
		return PVZRAPData::Locations::SURVIVAL_POOL_CLEAR;
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_4:
		return PVZRAPData::Locations::SURVIVAL_FOG_CLEAR;
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_5:
		return PVZRAPData::Locations::SURVIVAL_ROOF_CLEAR;
	case GAMEMODE_SURVIVAL_HARD_STAGE_1:
		return PVZRAPData::Locations::SURVIVAL_DAY_HARD_CLEAR;
	case GAMEMODE_SURVIVAL_HARD_STAGE_2:
		return PVZRAPData::Locations::SURVIVAL_NIGHT_HARD_CLEAR;
	case GAMEMODE_SURVIVAL_HARD_STAGE_3:
		return PVZRAPData::Locations::SURVIVAL_POOL_HARD_CLEAR;
	case GAMEMODE_SURVIVAL_HARD_STAGE_4:
		return PVZRAPData::Locations::SURVIVAL_FOG_HARD_CLEAR;
	case GAMEMODE_SURVIVAL_HARD_STAGE_5:
		return PVZRAPData::Locations::SURVIVAL_ROOF_HARD_CLEAR;
	case GAMEMODE_CHALLENGE_WAR_AND_PEAS:
		return PVZRAPData::Locations::MINIGAME_ZOMBOTANY_CLEAR;
	case GAMEMODE_CHALLENGE_WALLNUT_BOWLING:
		return PVZRAPData::Locations::MINIGAME_WALL_NUT_BOWLING_CLEAR;
	case GAMEMODE_CHALLENGE_SLOT_MACHINE:
		return PVZRAPData::Locations::MINIGAME_SLOT_MACHINE_CLEAR;
	case GAMEMODE_CHALLENGE_RAINING_SEEDS:
		return PVZRAPData::Locations::MINIGAME_RAINING_SEEDS_CLEAR;
	case GAMEMODE_CHALLENGE_BEGHOULED:
		return PVZRAPData::Locations::MINIGAME_BEGHOULED_CLEAR;
	case GAMEMODE_CHALLENGE_INVISIGHOUL:
		return PVZRAPData::Locations::MINIGAME_INVISIGHOUL_CLEAR;
	case GAMEMODE_CHALLENGE_SEEING_STARS:
		return PVZRAPData::Locations::MINIGAME_SEEING_STARS_CLEAR;
	case GAMEMODE_CHALLENGE_ZOMBIQUARIUM:
		return PVZRAPData::Locations::MINIGAME_ZOMBIQUARIUM_CLEAR;
	case GAMEMODE_CHALLENGE_BEGHOULED_TWIST:
		return PVZRAPData::Locations::MINIGAME_BEGHOULED_TWIST_CLEAR;
	case GAMEMODE_CHALLENGE_LITTLE_TROUBLE:
		return PVZRAPData::Locations::MINIGAME_BIG_TROUBLE_LITTLE_ZOMBIE_CLEAR;
	case GAMEMODE_CHALLENGE_PORTAL_COMBAT:
		return PVZRAPData::Locations::MINIGAME_PORTAL_COMBAT_CLEAR;
	case GAMEMODE_CHALLENGE_COLUMN:
		return PVZRAPData::Locations::MINIGAME_COLUMN_SEE_EM_CLEAR;
	case GAMEMODE_CHALLENGE_BOBSLED_BONANZA:
		return PVZRAPData::Locations::MINIGAME_BOBSLED_BONANZA_CLEAR;
	case GAMEMODE_CHALLENGE_SPEED:
		return PVZRAPData::Locations::MINIGAME_ZOMBIE_NIMBLE_ZOMBIE_QUICK_CLEAR;
	case GAMEMODE_CHALLENGE_WHACK_A_ZOMBIE:
		return PVZRAPData::Locations::MINIGAME_WHACK_A_ZOMBIE_CLEAR;
	case GAMEMODE_CHALLENGE_LAST_STAND:
		return PVZRAPData::Locations::MINIGAME_LAST_STAND_CLEAR;
	case GAMEMODE_CHALLENGE_WAR_AND_PEAS_2:
		return PVZRAPData::Locations::MINIGAME_ZOMBOTANY_2_CLEAR;
	case GAMEMODE_CHALLENGE_WALLNUT_BOWLING_2:
		return PVZRAPData::Locations::MINIGAME_WALL_NUT_BOWLING_2_CLEAR;
	case GAMEMODE_CHALLENGE_POGO_PARTY:
		return PVZRAPData::Locations::MINIGAME_POGO_PARTY_CLEAR;
	case GAMEMODE_CHALLENGE_FINAL_BOSS:
		return PVZRAPData::Locations::MINIGAME_ZOMBOSS_REVENGE_CLEAR;
	...
	case GAMEMODE_SCARY_POTTER_1:
		return PVZRAPData::Locations::PUZZLE_VASEBREAKER_CLEAR;
	case GAMEMODE_SCARY_POTTER_2:
		return PVZRAPData::Locations::PUZZLE_TO_THE_LEFT_CLEAR;
	case GAMEMODE_SCARY_POTTER_3:
		return PVZRAPData::Locations::PUZZLE_THIRD_VASE_CLEAR;
	case GAMEMODE_SCARY_POTTER_4:
		return PVZRAPData::Locations::PUZZLE_CHAIN_REACTION_CLEAR;
	case GAMEMODE_SCARY_POTTER_5:
		return PVZRAPData::Locations::PUZZLE_M_FOR_METAL_CLEAR;
	case GAMEMODE_SCARY_POTTER_6:
		return PVZRAPData::Locations::PUZZLE_SCARY_POTTER_CLEAR;
	case GAMEMODE_SCARY_POTTER_7:
		return PVZRAPData::Locations::PUZZLE_HOKEY_POKEY_CLEAR;
	case GAMEMODE_SCARY_POTTER_8:
		return PVZRAPData::Locations::PUZZLE_ANOTHER_CHAIN_REACTION_CLEAR;
	case GAMEMODE_SCARY_POTTER_9:
		return PVZRAPData::Locations::PUZZLE_ACE_OF_VASE_CLEAR;
	case GAMEMODE_SCARY_POTTER_ENDLESS:
		break;
	case GAMEMODE_PUZZLE_I_ZOMBIE_1:
		return PVZRAPData::Locations::PUZZLE_I_ZOMBIE_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_2:
		return PVZRAPData::Locations::PUZZLE_I_ZOMBIE_TOO_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_3:
		return PVZRAPData::Locations::PUZZLE_DIG_IT_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_4:
		return PVZRAPData::Locations::PUZZLE_TOTALLY_NUTS_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_5:
		return PVZRAPData::Locations::PUZZLE_DEAD_ZEPPELIN_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_6:
		return PVZRAPData::Locations::PUZZLE_ME_SMASH_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_7:
		return PVZRAPData::Locations::PUZZLE_ZOMBOOGIE_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_8:
		return PVZRAPData::Locations::PUZZLE_THREE_HIT_WONDER_CLEAR;
	case GAMEMODE_PUZZLE_I_ZOMBIE_9:
		return PVZRAPData::Locations::PUZZLE_BRAINZ_BELONG_TO_US_CLEAR;
	...
	case GAMEMODE_INTRO:
		break;
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_6:
		break;
	case GAMEMODE_SURVIVAL_NORMAL_STAGE_HIGHGROUND:
		break;
	case GAMEMODE_SURVIVAL_HARD_STAGE_6:
		break;
	case GAMEMODE_SURVIVAL_HARD_STAGE_HIGHGROUND:
		break;
	case GAMEMODE_SURVIVAL_ENDLESS_STAGE_6:
		break;
	case GAMEMODE_SURVIVAL_ENDLESS_STAGE_HIGHGROUND:
		break;
	case GAMEMODE_LAST_STAND_STAGE_1:
		break;
	case GAMEMODE_LAST_STAND_STAGE_2:
		break;
	case GAMEMODE_LAST_STAND_STAGE_3:
		break;
	case GAMEMODE_LAST_STAND_STAGE_4:
		break;
	case GAMEMODE_LAST_STAND_STAGE_5:
		break;
	case GAMEMODE_LAST_STAND_ENDLESS_STAGE_1:
		break;
	case GAMEMODE_LAST_STAND_ENDLESS_STAGE_2:
		break;
	case GAMEMODE_LAST_STAND_ENDLESS_STAGE_3:
		break;
	case GAMEMODE_LAST_STAND_ENDLESS_STAGE_4:
		break;
	case GAMEMODE_LAST_STAND_ENDLESS_STAGE_5:
		break;
	case NUM_GAME_MODES:
		break;
	}
...
bool LawnApp::HasBeatenChallenge(GameMode theGameMode)
{
	...
	auto apLocation = ChallengeCompletionLocation(theGameMode);
	if (apLocation != -1)
	{
